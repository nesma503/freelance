                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label onclick="changeActiveButton(this.id)" id="btnFreelancer" class="btn btn-lg button <?php if ($userType == "" || $userType == 1) echo 'btn-primary';
                                                                                                                                    else echo 'btn-secondary'; ?>">
                                            <input type="radio" name="userType" value="1" <?php if ($userType == 1) echo 'checked'; ?>> Freelancer
                                        </label>
                                        <label onclick="changeActiveButton(this.id)" id="btnRecruiter" class="btn btn-primary btn-lg button <?php if ($userType == "" || $userType == 2) echo 'btn-primary';
                                                                                                                                            else echo 'btn-secondary'; ?>">
