                ...
                <div class="col-6 signup-form">
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <button type="button" id="btnFreelancer" onclick="changeActiveButton(this.id)" class="form-control btn btn-lg <?php if ($userType == "1") echo 'btn-primary';
                                                                                                                                                    else echo 'btn-secondary'; ?> ">
                                        Freelancer
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" id="btnRecruiter" onclick="changeActiveButton(this.id)" class="form-control btn btn-lg <?php if ($userType == "2") echo 'btn-primary';
                                                                                                                                                    else echo 'btn-secondary'; ?> ">
                                        Recruiter
                                    </button>
                                </div>
