...
// get jobs by recrtuiter
$jobs = Job::GetAll($recruiter->Id, $category, $sort, $page);
if (count($jobs) > 0) {
  ...
  <div class="container-fluid">
    <div class="row fill-height">
      <div class="col-3 z-index-2">
        <!-- menu -->
        <?php menu($recruiter->UserTypeId, "jobs", $recruiter->Username); ?>
      </div>
      <!-- page -->
        ...
        <div class="container-fluid">
          ...
          <form class="form" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
            ...
            <div class="row">
              ...
              <div class="col-2">
                <a href="./recruiter-jobs.php?page=<?php echo $previousPage ?>&category=<?php echo $category ?>&sort=<?php echo $sort ?>" class="btn btn-primary btn-md btn-block <?php if ($previousPage < 1) echo 'disabled'; ?>">Previous</a>
              </div>
              <div class="col-2">
                <a href="./recruiter-jobs.php?page=<?php echo $nextPage ?>&category=<?php echo $category ?>&sort=<?php echo $sort ?>" class="btn btn-primary btn-md btn-block <?php if ($nextPage > $totalPages) echo 'disabled'; ?>">next</a>
              </div>
            </div>
          </form>
        </div>
