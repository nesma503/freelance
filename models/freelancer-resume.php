...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $freelancer->DegreeId = $_POST["degree"];
  $freelancer->Major = $_POST["major"];
  $freelancer->UniversityName = $_POST["university"];
  $freelancer->LastWork = $_POST["lastWork"];
  $freelancer->ExperienceYears = $_POST["experience"];
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <a href="<?php echo 'download.php?path=../uploaded-documents/'.$cv.'&username='.$freelancer->Username; ?>" download>
                      <img src="../img/cv.png">
                      Download
                    </a>
                  </div>
                ...
                <div class="col">
                  ...
                  <div class="d-flex justify-content-center">
                  <a href="<?php echo 'download.php?path=../uploaded-images/'.$cv.'&username='.$freelancer->Username; ?>" download>
